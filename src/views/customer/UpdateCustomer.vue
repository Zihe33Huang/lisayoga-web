<template>
  <el-dialog :title="$t('buttons.edit')" width="450px"
...
<!--      </el-form-item>-->
      ...
      <el-form-item v-if="form.type === 0|| form.type === 2" label-width="100px" :label="$t('member_labels.entryTime')" prop="name">
        <div class="block">
          <el-date-picker
      ...
      <el-form-item v-if="form.type === 0|| form.type === 2" :label="$t('member_labels.weight')" prop="name">
        <el-input  v-model="form.weight" class="tams-form-item"></el-input>
      </el-form-item>
      <el-form-item v-if="form.type === 0|| form.type === 2" :label="$t('member_labels.height')" prop="name">
...
<!--      </el-form-item>-->
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button v-if="form.type === 0 || form.type === 1" type="primary" :loading="submitBtnLoading" @click="submit">{{$t('buttons.confirm')}}</el-button>
      <el-button v-else-if="this.form.enterTime == null" type="warning" :loading="submitBtnLoading" @click="submit">确定转正</el-button>
      <el-button v-else type="primary" :loading="submitBtnLoading" @click="submit">{{$t('buttons.confirm')}}</el-button>
    </div>
  </el-dialog>
</template>
