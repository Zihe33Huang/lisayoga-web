<template>
  <el-dialog :title="$t('schedule_labels.modify')" width="790px"
    ...
    <el-form ref="form" :model="form" :rules="rules" inline label-width="80px" class="tams-form-container">
      ...
      <br/>
      <el-form-item :label="$t('schedule_labels.course')" prop="courseId">
      ...
      <el-form-item :label="$t('schedule_labels.teacher')" prop="teacherId">
      ...
      <el-form-item :label="$t('schedule_labels.attendTime')" prop="attendTime">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click="close">{{$t('schedule_labels.cancel')}}</el-button>
      <el-button type="primary" :loading="submitBtnLoading" @click="submit">{{$t('schedule_labels.confirm')}}</el-button>
    </div>
  </el-dialog>
</template>
